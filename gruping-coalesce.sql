...
from employee as E join tblAttendance as A
on E.EmployeeNumber = A.EmployeeNumber
group by ROLLUP (E.Department, E.EmployeeNumber, A.AttendanceMonth) -- Así que no necesitas usar varios UNION como antes — ROLLUP lo hace solo.
order by Department, EmployeeNumber, AttendanceMonth
--CASE GROUPING_ID(E.Department, E.EmployeeNumber, A.AttendanceMonth)
 -- WHEN 0 THEN 'Detalle mensual'
 -- WHEN 1 THEN 'Subtotal empleado'
 -- WHEN 3 THEN 'Subtotal departamento'
 -- WHEN 7 THEN 'Total general'
--END AS Nivel
